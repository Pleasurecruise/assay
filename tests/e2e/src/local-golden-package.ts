...
export interface PreparedLocalGoldenPackage {
  readonly root: string;
...
export async function prepareLocalGoldenPackage(
  options: PrepareLocalGoldenPackageOptions,
): Promise<PreparedLocalGoldenPackage> {
