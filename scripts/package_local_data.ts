...
import { CASE_DATA_PACKAGE_ROOT, exportCsi300MomentumCasePackage } from "./case_data_package";
...
const exported = await exportCsi300MomentumCasePackage({
